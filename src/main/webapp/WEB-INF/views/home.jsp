		...
		<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
				...
				<div data-am-widget="slider" class="am-slider am-slider-default"
					...
					<c:forEach items="${activity}" var="a">
						<li data-thumb="${pageContext.request.contextPath}${a.activity_img}1.jpeg"><a href="${pageContext.request.contextPath}/activity_show.do?activity_id=${a.activity_id}"><img
								src="${pageContext.request.contextPath}${a.activity_img}1.jpeg" style="height: 480px;"></a>
								</li>
									</c:forEach>
					</ul>
				</div>
			...
			<div class="am-list-news-bd">
				...
				<li
						...
						<div class="am-u-sm-5 am-list-thumb">
							<a href="${pageContext.request.contextPath}/informationShow.do?infoId=${i.info_id}"> <img
					...
					<div class="newsico am-fr">
						<i class="am-icon-clock-o"><fmt:formatDate value="${i.info_date}" type="date" pattern="yyyy-MM-dd"/></i>
					</div>
				</c:forEach>
				...
				<div class="am-gallery-item">
					<a href="${pageContext.request.contextPath}/activity_show.do?activity_id=${ac.activity_id}" >
						...
						<div class="am-gallery-desc">
							...
							<div class="am-fl"><fmt:formatDate value="${ac.activity_date}" type="date" pattern="yyyy-MM-dd"/></div>
						</div>
					</a>
				</div>
			</li>
